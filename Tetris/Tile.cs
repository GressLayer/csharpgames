...
namespace Tetris
{
    ...
    class Tile : SpriteGameObject
    {
        ...
        public Tile(bool IsBottomRow) : base("sprites/Tetromino")
        {
        ...
        {
            {
                if (IsOccupied)
                {
                    switch (colorNumber)
                    {
                        case (0): currentColor = Color.Orange; break;
                        case (1): currentColor = Color.Blue; break;
                        case (2): currentColor = Color.Red; break;
                        case (3): currentColor = Color.Lime; break;
                        case (4): currentColor = Color.Cyan; break;
                        case (5): currentColor = Color.Yellow; break;
                        case (6): currentColor = Color.Magenta; break;
                    }
                }
                else
                    currentColor = Color.White;
